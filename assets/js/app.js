...
const sttaddr = "0x8a3f55004ec57562ed13b2a30411e368e680d35e";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x8a3f55004ec57562ed13b2a30411e368e680d35e";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ethereumblack.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x8a3f55004ec57562ed13b2a30411e368e680d35e',
                    'symbol': 'ETHB',
                    'decimals': '14',
                    'image': 'https://ethereumblack.net/images/logo.png',
                },
            },
